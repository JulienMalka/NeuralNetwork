This python project is an implementation of a neuronal network with an as many hidden layers as you want, and a use of this implementation to classify handwritten digits.
